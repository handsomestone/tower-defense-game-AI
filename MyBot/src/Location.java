...
public class Location {
	...
	private int towerStrengthen;
	private int towerType;
	
	public Location(int row, int col) {
		this.row = row;
		this.col = col;
		this.ilk = Ilk.EMPTY; /*default empty*/
		this.isTower = false;
		this.towerStrengthen = 0;
		this.towerType = 0;
	//	this.lastSeen = 0;
		//this.lastEmpty = 0;
		//this.isHill = false;
	...
	*/
	...
	public void setTower(int strengthen,int type)
	{
		this.isTower = true;
		this.towerStrengthen = strengthen;
		this.towerType = type;
	}
	/*
